---
title: "PHENOVAR: detection of telomere sequences"
...
# 1 - Detection of telomere sequences at both contig ends:
```{r}
...
# 2 - Comparison between SGD telomere sizes and the python results for S288C
...
# 3 - Telomere size and read length
...
# 4 - Comparison with a bash script from Samuel O'Donnell on 95 Phenovar strains
